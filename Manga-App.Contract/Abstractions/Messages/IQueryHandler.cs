...
/// <summary>
/// Represents a handler for processing queries of type <typeparamref name="TRequest"/> 
/// and returning a response of type <typeparamref name="TResponse"/>.
/// This interface is used to define the logic for handling queries within the application,
/// and it inherits from <see cref="IRequestHandler{TRequest, Result{TResponse}}"/> 
/// to integrate with MediatR.
/// </summary>
/// <typeparam name="TRequest">The type of the query request that implements <see cref="IQuery{TResponse}"/>.</typeparam>
/// <typeparam name="TResponse">The type of the response returned by the query handler.</typeparam>
/// <remarks>
/// Query handlers are responsible for executing the business logic associated with a query,
