...
namespace Manga_App.Persistence.Migrations
{
    ...
    [Migration("20250308090239_AddNotificationTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MangaApp.Domain.Entities.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MangaApp.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MangaApp.Domain.Entities.Comment", b =>
                {
                    b.HasOne("MangaApp.Domain.Entities.Comment", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("MangaApp.Domain.Entities.Notification", b =>
                {
                    b.HasOne("MangaApp.Domain.Entities.Identity.AppUser", "Receive")
                        .WithMany("ReceiveNotifications")
                        .HasForeignKey("ReceiveId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MangaApp.Domain.Entities.Identity.AppUser", "Sender")
