...
public class PublishMangaCommandHandler : ICommandHandler<PublishMangaCommand, Success>
{
    private readonly IUnitOfWork _unitOfWork;
    public PublishMangaCommandHandler(IUnitOfWork unitOfWork)
    {
